...
/* 
	...
	Purpose: Expects a username and password, returns nothing. Shows a dropdown
		menu of owners and inputs for owner's email address and phone number. 
...
function select_owner($username, $password)
{
	...
	<form action="<?= htmlentities($_SERVER['PHP_SELF'],
		...
		<div class="sub_button">
			<input type="submit" value="Add new contact info" />
		</div>
	</form>
	<?php
}

...
insert into rental
values
('0000001', '5555','120011', '21-SEP-2018', '23-SEP-2018', '22-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000002', '2222','130031', '19-SEP-2018', '22-SEP-2018');

insert into rental
values
('0000003', '2222','130012', '03-SEP-2018', '08-SEP-2018', '04-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000004', '3333','130012', '21-SEP-2018', '22-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000005', '3333','210011', '08-AUG-2018', '11-AUG-2018');

insert into rental
values
('0000007', '3333','120011', '15-SEP-2018', '18-SEP-2018', '21-SEP-2018');

insert into rental
values
('0000008', '1111','130022', '04-SEP-2018', '07-SEP-2018', '14-SEP-2018');

insert into rental
values
('0000009', '6666', '130012', '13-SEP-2018', '16-SEP-2018', '16-SEP-2018');

insert into rental
values
('0000010', '7777', '120011', '14-SEP-2018', '17-SEP-2018', '17-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000011', '8888', '230012', '05-SEP-2018', '10-SEP-2018');

insert into rental
values
('0000012', '9999', '210031', '10-SEP-2018', '13-SEP-2018', '13-SEP-2018');

insert into rental
values
('0000013', '9999', '210041', '10-SEP-2018', '13-SEP-2018', '13-SEP-2018');

insert into rental
values
('0000014', '9999', '230033', '10-SEP-2018', '13-SEP-2018', '13-SEP-2018');

insert into rental
values
('0000015', '3333', '420011', '01-SEP-2018', '04-SEP-2018', '03-SEP-2018');

insert into rental
values
('0000016', '2222', '330023', '11-SEP-2018', '16-SEP-2018', '15-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000017', '5555', '220013', '22-SEP-2018', '25-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000018', '1111', '220062', '21-SEP-2018', '26-SEP-2018');

insert into rental
values
('0000019', '3333', '320032', '06-SEP-2018', '09-SEP-2018', '07-SEP-2018');

insert into rental
values
('0000020', '7777', '130031', '29-AUG-2018', '01-SEP-2018', '02-SEP-2018');

insert into rental(rental_num, client_num, vid_id, date_out, date_due)
values
('0000021', '6666', '210011', '15-SEP-2018', '17-SEP-2018');

insert into rental
values
('0000022', '5555', '210031', '16-SEP-2018', '18-SEP-2018', '17-SEP-2018');

insert into rental
values
('0000023', '4444', '120011', '16-SEP-2018', '18-SEP-2018', '21-SEP-2018');

insert into rental
values
('0000024', '7777', '130031', '08-SEP-2018', '10-SEP-2018', '09-SEP-2018');
